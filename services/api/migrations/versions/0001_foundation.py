...
ENUMS: dict[str, tuple[str, ...]] = {
    "entity_type": (
        "unspecified", "unknown", "vessel", "aircraft", "organization", "person",
        "place", "port", "airport", "facility", "pipeline", "submarine_cable",
        "vehicle", "satellite", "financial_instrument", "commodity", "admin_area",
        "maritime_zone", "airspace", "network_asset", "event_series",
    ),
    "resolution_status": (
        "unspecified", "pending", "unresolved", "resolved", "ambiguous",
        "conflicted", "merged",
    ),
    "identifier_stability": ("unspecified", "stable", "mutable", "ephemeral"),
    "alias_kind": (
        "unspecified", "name", "former_name", "transliteration", "translation",
        "abbreviation", "callsign", "trade_name",
    ),
    "source_reliability": ("unspecified", "a", "b", "c", "d", "e", "f"),
    "information_credibility": ("unspecified", "1", "2", "3", "4", "5", "6"),
    "source_kind": (
        "unspecified", "rest_api", "stream", "feed", "batch_file", "webhook",
        "sensor", "manual", "derived",
    ),
    "source_domain": (
        "unspecified", "aviation", "maritime", "news", "economic", "conflict",
        "disaster", "corporate", "sanctions", "geo", "weather", "space", "cyber",
        "infrastructure",
    ),
    "time_precision": (
        "unspecified", "second", "minute", "hour", "day", "month", "year", "unknown",
    ),
    "time_quality": (
        "unspecified", "source_provided", "source_provided_coarse",
        "inferred_from_ingest", "implausible", "missing",
    ),
    "geo_precision": (
        "unspecified", "exact", "building", "city", "admin1", "country",
        "maritime_zone", "unknown",
    ),
    "observation_kind": (
        "unspecified", "position", "status", "measurement", "static_data",
    ),
    "event_status": (
        "unspecified", "rumored", "reported", "confirmed", "disputed", "retracted",
        "superseded", "scheduled",
    ),
    "entity_role": (
        "unspecified", "actor", "target", "affected", "location", "mentioned",
        "source", "operator", "owner",
    ),
    "event_link_type": (
        "unspecified", "duplicate_of", "part_of", "follows",
        "caused_by_hypothesis", "contradicts", "updates", "correlated_with",
    ),
    "report_kind": (
        "unspecified", "news_article", "agency_wire", "press_release",
        "government_notice", "regulatory_filing", "social_post", "blog",
        "situation_report", "advisory", "dataset_record",
    ),
    "relation_type": (
        "unspecified", "owns", "beneficial_owner_of", "controls", "operates",
        "manages", "subsidiary_of", "parent_of", "director_of", "employed_by",
        "member_of", "registered_in", "flagged_in", "located_at", "docked_at",
        "supplies_to", "customer_of", "transported_by", "sanctioned_by",
        "part_of", "connected_to", "rendezvous_with", "successor_of",
        "associated_with", "other",
    ),
    "sanction_status": (
        "unspecified", "none", "listed", "delisted", "associated",
        "possible_match", "not_checked",
    ),
    "assessment_kind": (
        "unspecified", "hypothesis", "judgement", "forecast", "classification",
        "correlation", "risk", "attribution",
    ),
    "author_type": ("unspecified", "human", "model", "rule", "detector", "external"),
    "confidence_basis": (
        "unspecified", "model", "rule", "human_judgement", "statistical",
        "corroboration",
    ),
    "outcome_verdict": (
        "unspecified", "confirmed", "partially_confirmed", "refuted",
        "undecidable", "expired",
    ),
    "evidence_kind": (
        "unspecified", "report", "observation", "event", "entity", "relation",
        "track", "detector_hit", "external_document", "human_statement",
    ),
    "object_kind": (
        "unspecified", "observation", "event", "entity", "relation", "report",
        "track", "assessment", "source", "aoi", "watchlist", "alert", "case",
    ),
    "alert_severity": ("unspecified", "watch", "notify", "alert", "critical"),
    "alert_status": (
        "unspecified", "new", "acked", "investigating", "resolved",
        "false_positive", "suppressed", "expired",
    ),
    "resolution_disposition": (
        "unspecified", "true_positive", "false_positive", "benign", "duplicate",
        "data_quality", "undetermined",
    ),
    "aoi_kind": ("unspecified", "polygon", "circle", "corridor", "named_zone", "dynamic"),
    "zone_type": (
        "unspecified", "eez", "territorial_waters", "strait", "port_limit",
        "anchorage", "fir", "restricted_airspace", "admin_area",
        "sanction_zone", "chokepoint",
    ),
    "match_mode": (
        "unspecified", "exact_id", "entity", "pattern", "fuzzy_name", "attribute",
    ),
    "case_status": (
        "unspecified", "open", "investigating", "on_hold", "closed", "archived",
    ),
    "case_priority": ("unspecified", "low", "medium", "high", "urgent"),
    "visibility": ("unspecified", "private", "team", "org", "public"),
    "gap_reason": (
        "unspecified", "source_unavailable", "rate_limited", "no_coverage",
        "signal_loss", "filtered", "license_restricted", "pipeline_failure",
        "unknown",
    ),
}
