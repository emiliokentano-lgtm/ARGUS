...
stattdessen die Speicherzuweisung entscheidend: *Settings → Resources →* mindestens
8 GB, besser 12 GB.
...
3. **Warten** (`scripts/wait-ready.sh`) — bis jeder dauerhafte Dienst *healthy*
...
Buckets, die Streams und die Templates *wirklich*? Ein Container kann healthy
